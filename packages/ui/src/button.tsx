...
const buttonVariants = cva(
	[
		"inline-flex shrink-0 items-center justify-center gap-1.5 rounded-full text-[13px] font-normal leading-4 tracking-[-0.01em] whitespace-nowrap outline-none transition-[transform,background-color,border-color,color,box-shadow,opacity,filter] duration-150 ease-out",
		nativeFocusRing,
