		...
		>
			...
			<div className="flex items-center gap-1.5">
				...
				<Button className="hover:bg-transparent" size={"sm"} variant={"ghost"}>
					<Link href={"https://github.com/cortex-md/cortex"}>
				...
				<Link
					href="/docs"
					className="hidden rounded-md px-3 py-[5px] text-[13.5px] text-muted-foreground no-underline transition-colors duration-150 hover:bg-secondary hover:text-primary sm:block"
				>
					Docs
				</Link>
				...
				<Button
					asChild
					size="sm"
					className="h-auto px-3.5 py-[7px] text-[13.5px] font-semibold hover:bg-accent/90"
				>
