...
export default function Cta() {
	return (
		<section className="bg-ink-800 px-10 py-[120px] text-center">
			<ScrollReveal className="mx-auto max-w-[600px]">
				...
				<p className="mb-9 text-[16px] text-ink-200" style={{ lineHeight: 1.65 }}>
					Gratuito para sempre para uso pessoal. Sem cartão de crédito. Seus dados nunca saem do
					seu dispositivo.
				</p>
