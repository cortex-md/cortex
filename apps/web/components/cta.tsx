	...
	},
	{
		...
		icon: (
			<svg
				viewBox="0 0 24 24"
				className="h-[15px] w-[15px]"
				style={{ fill: "none", stroke: "var(--text-muted)" }}
				strokeWidth="1.5"
				aria-hidden="true"
			>
...
export default function Cta() {
	return (
		<section className="px-6 py-[120px] text-center" style={{ background: "var(--bg-secondary)" }}>
			<div className="mx-auto max-w-[600px]">
				...
				<p className="mb-9 text-muted-foreground" style={{ fontSize: "16px", lineHeight: 1.65 }}>
					Free for personal use. No credit card. Your notes stay in plain Markdown files on your
					device — always.
				</p>
