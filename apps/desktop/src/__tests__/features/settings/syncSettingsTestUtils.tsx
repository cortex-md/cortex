...
export const saveServerUrl: AsyncMock = vi.fn().mockResolvedValue(undefined)
...
export const unlinkVault: AsyncMock = vi.fn().mockResolvedValue(undefined)
export const loadLink: AsyncMock = vi.fn().mockResolvedValue(undefined)
...
export const updateSyncPreference: AsyncMock = vi.fn().mockResolvedValue(undefined)
